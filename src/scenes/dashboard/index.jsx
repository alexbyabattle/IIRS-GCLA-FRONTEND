    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        if (lastIncident && lastIncident.createdAt) {
          ...
          // Create a map to count occurrences of each location
          ...
          if (referenceLocation) {
            ...
            const sameLocationIncidents = filteredIncidents.filter(incident => {
              return incident.users.some(user => user.location === referenceLocation);
            });
  ...
  return (
    <Box m="20px">
      ...
      >
        ...
        {userDepartment === 'IT' && (userRole === 'MANAGER' || userRole === 'ADMIN') ? (
          <Box
            gridColumn="span 4"
            backgroundColor={colors.primary[400]}
            display="flex"
